...
rcpm_1A = run_rcpm(corr_clusters(:, :,sub_idx, :), cohort_1AB.distress(sub_idx), thresh, "rest_tolpre_spt_x_distress");

% run 1B, rest_tolpre_spt_x_tolrt
fprintf('Running rcpm_1B...\n')
rcpm_1B = run_rcpm(corr_clusters(:, :,sub_idx, :), cohort_1AB.meanrt2(sub_idx), thresh, "rest_tolpre_spt_x_tolrt");

clearvars -except rcpm_1A rcpm_1B

save('/scratch/st-tv01-1/ocd/analysis/part1/rcpm_part1AB_n53-p01-OCD.mat')